...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        let invalidMsg = new MessageEmbed()
            ...
            .addField(`Usage:`, `\`${prefix}setigt <user> <time in hours>\``)
            .setColor(errorColor)
        ...
        invalidMsg.setDescription('Invalid or Missing hours for In Game Time\nPlease enter your response in hours')
        ...
        message.channel.send(new MessageEmbed().setTitle('Succesfully Modified In Game Time').setDescription(`<@${target.id}>'s In Game Time have been set to \`${args[1]}.\` hours`).setColor('#00FFFF'))
    }
}